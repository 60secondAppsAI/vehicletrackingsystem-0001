					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateOwner()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div id="app">
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Owners = true">Add</base-button>
								              <modal :show.sync="modal2Owners">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Owner Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="OwnerId" type="text" placeholder="Enter OwnerId" v-model="ownerDetails.ownerId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="ownerDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Contact Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactNumber" type="text" placeholder="Enter ContactNumber" v-model="ownerDetails.contactNumber"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateOwner() {
      ...
      const jsonData = JSON.stringify(this.ownerDetails);
      const res = await OwnerService.update(jsonData);
...
//        this.getAllOwners();
    ...
    async getOwnerDetails() {
      try {
			let response = await OwnerService.get(this.ownerId);
